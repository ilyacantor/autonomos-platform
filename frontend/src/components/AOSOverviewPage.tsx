          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-6 bg-slate-900/50 rounded-xl border border-slate-800">
                <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-2">1,000+</div>
              ...
              <div className="p-6 bg-slate-900/50 rounded-xl border border-slate-800">
                <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-2">80%</div>
              ...
              <div className="p-6 bg-slate-900/50 rounded-xl border border-slate-800">
                <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-2">$2.6T</div>
              ...
              <div className="p-6 bg-slate-900/50 rounded-xl border border-slate-800">
                <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-2">60%+</div>
      ...
      <section id="section-paradigm" className="w-full max-w-6xl mx-auto px-6 py-24 md:py-32 border-t border-slate-800">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">From Software to Intelligence</span>
          </h2>
        ...
        <div className="w-full md:w-[420px] h-auto md:h-full bg-slate-900/80 backdrop-blur-xl border-t md:border-t-0 md:border-l border-slate-800 p-6 flex flex-col shrink-0 z-20 shadow-[-10px_0_30px_rgba(0,0,0,0.2)] overflow-y-auto">
          <div className="mb-6">
            <h2 className="text-lg font-bold text-white mb-1">
              autonom<span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">OS</span> Platform (AOS) Components
            </h2>
