...
export default function DataLineagePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-medium text-white mb-2">Data Lineage</h1>
      ...
      {hasSearched && (
        <div className="bg-gray-900 rounded-xl border border-gray-800 p-8">
          <div className="mb-8">
            <h2 className="text-xl font-medium text-white mb-6">Lineage Flow</h2>
              ...
              {stages.map((stage, index) => (
                <div key={stage.id} className="flex items-center">
                  <div className="text-center">
                    ...
                    >
                      <span className="text-white text-sm px-2 text-center">
                        {stage.label}
                      </span>
                    </div>
