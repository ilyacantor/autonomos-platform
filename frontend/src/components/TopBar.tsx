...
import { LayoutDashboard, Cable, Network, Bell, Menu, X, LogIn, UserPlus, HelpCircle, Search, BookOpen, Sparkles, Play, Database, Activity, Target } from 'lucide-react';
...
export default function TopBar({ onAuthOpen, currentPage, onNavigate }: TopBarProps) {
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'farm-stress-test', label: 'Stress Test', icon: <Target className="w-5 h-5" />, tooltip: 'FARM stress test monitor' },
