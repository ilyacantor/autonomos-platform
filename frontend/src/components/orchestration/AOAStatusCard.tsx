...
import type { OrchestrationVitals, AOAState, AutonomyMode } from './types';
...
export default function AOAStatusCard() {
  const [vitals, setVitals] = useState<OrchestrationVitals | null>(null);
    ...
    <div className="rounded-2xl shadow-md p-6 bg-slate-800/60 border border-slate-700 relative overflow-hidden h-full">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className={`px-4 py-2 rounded-lg border ${getStateColor(vitals.state)}`}>
