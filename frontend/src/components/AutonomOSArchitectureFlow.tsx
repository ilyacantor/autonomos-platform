    ...
    <div className="relative px-4 sm:px-6 py-6 sm:py-8 safe-x">
      ...
      <div className="max-w-7xl mx-auto border-2 border-cyan-500/30 rounded-lg p-4 sm:p-6 bg-gradient-to-b from-slate-900/30 to-transparent relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] gap-4 items-center mb-8">
          {/* Enterprise Data */}
          <div className="bg-slate-800/80 border border-slate-600/50 rounded-lg p-4 sm:p-6 h-full flex flex-col justify-center">
            ...
            <div className="mobile-scroll-x md:flex md:flex-wrap gap-2 md:justify-center pb-2 md:pb-0">
          ...
          <button
            ...
            className="bg-gradient-to-br from-cyan-900/40 to-slate-800/80 border border-cyan-500/50 hover:border-cyan-400 rounded-lg p-4 sm:p-6 h-full flex flex-col justify-center transition-all hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/20 cursor-pointer group mobile-tap-highlight touch-target-h"
          >
            <div className="flex items-center gap-2 mb-3 sm:mb-4 justify-center">
            ...
            <div className="mobile-scroll-x md:flex md:flex-wrap gap-2 md:justify-center mb-2 sm:mb-3 pb-2 md:pb-0">
              <div className="flex md:flex-wrap gap-2 md:justify-center whitespace-nowrap md:whitespace-normal">
          ...
          <button
            ...
            className="bg-gradient-to-br from-blue-900/40 to-slate-800/80 border border-blue-500/50 hover:border-blue-400 rounded-lg p-4 sm:p-6 h-full flex flex-col justify-center transition-all hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 cursor-pointer group mobile-tap-highlight touch-target-h"
          >
            <div className="flex items-center gap-2 mb-3 sm:mb-4 justify-center">
          ...
          <button
            ...
            className="bg-gradient-to-br from-purple-900/40 to-slate-800/80 border border-purple-500/50 hover:border-purple-400 rounded-lg p-4 sm:p-6 h-full flex flex-col justify-center transition-all hover:scale-105 hover:shadow-lg hover:shadow-purple-500/20 cursor-pointer group mobile-tap-highlight touch-target-h"
          >
            <div className="flex items-center gap-2 mb-3 sm:mb-4 justify-center">
        ...
        <div className="flex justify-center">
          <div className="w-full md:w-auto bg-gradient-to-br from-cyan-900/40 to-slate-800/80 border border-cyan-500/50 rounded-lg p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-3 sm:mb-4 justify-center">
