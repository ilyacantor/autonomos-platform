        ...
        <div>
          ...
          <div className="space-y-3">
            {services.map(service => (
              <div
                key={service.id}
                className="bg-gray-700/50 border border-gray-600 rounded-lg p-3 hover:bg-gray-600/50 transition-colors"
              >
                <div className="flex items-center justify-between">
                  <span className="font-medium text-white">{service.id.replace('_mock', '')}</span>
          ...
          <div className="space-y-3">
            {connectors.map(connector => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-sm text-white">{connector.connector_id}</div>
          ...
          <div className="space-y-3">
            {workflows.slice(0, 5).map(workflow => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-sm text-white">{workflow.workflow_type}</div>
