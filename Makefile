...
.PHONY: prod-backfill-tenants
prod-backfill-tenants:
        @echo "🔧 Backfilling NULL tenant_id values..."
...
help:
        ...
        @echo "  make prod-backfill-tenants  - Backfill NULL tenant_id in connections table"
        @echo ""
