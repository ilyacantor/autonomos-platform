...
class RedisDecodeWrapper:
    """
    Wrapper that provides decode_responses=True behavior for a Redis client
    that was created with decode_responses=False.
    """
    ...
    def set(self, key: str, value: str, **kwargs) -> bool:
        result = self._client.set(key, value, **kwargs)
        return bool(result)
